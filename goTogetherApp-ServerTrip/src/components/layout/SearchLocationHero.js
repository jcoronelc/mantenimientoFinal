...
const SearchLocationInput = ({ onPlaceSelected }) => {
    ...
    <div className="flex flex-col">
        <div className="mt-2 sm:col-span-3">
            ...
            <input
                ...
                className="text-gray-900 text-sm rounded-lg block w-full ps-10 p-3  dark:placeholder-gray-400 dark:text-white h-12"
