    ...
    return (
        <div className="flex justify-center items-center">
            <form onSubmit={handleSubmit} className="w-full p-4 ">
                <h2 className="text-blue-800 text-2xl font-extrabold mt-6 mb-2">Hablanos un poco de tí</h2>
                <p className="text-gray-700 mb-6">
                    Cuentanos un poco sobre ti, a qué te dedicas y cuáles son las cosas que te gustan
                </p>
                <input
                    id="aboutMe"
                    name="aboutMe"
